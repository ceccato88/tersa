...
export const LoginEmailTemplate = ({
  ...
  <Html>
    <Head />
    <Preview>Your magic link to login to WOW</Preview>
    <EmailLayout>
      <Text className="text-left text-[#525f7f] text-base leading-6">
        Hello there! Someone (hopefully you) requested to login to WOW.
      </Text>
      <Text className="text-left text-[#525f7f] text-base leading-6">
        Click the button below to securely login to your WOW account. No
        password needed!
      </Text>
      <Link
